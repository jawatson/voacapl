...
c jw         character run_directory*50
     ...
     +        'database'//PATH_SEPARATOR//'cirafp.911',status='old',err=900)
      rewind(31)
...
10    ciraf_lon(itp)=lond
      ...
      open(31,file=run_directory(1:nch_run-3)//
     +        'database'//PATH_SEPARATOR//'cirafp.max',status='old',err=910)
      rewind(31)
      do 30 izn=1,85
      do 20 j=1,2
...
30    continue
      ...
      return
c***********************************************************
900   write(*,901) '..'//PATH_SEPARATOR//'DATABASE'//PATH_SEPARATOR//'CIRAFP.911'
901   format(' In rdciraf, could not OPEN file=',a)
      pause 'Could not OPEN file ..'//PATH_SEPARATOR//'DATABASE'//PATH_SEPARATOR//'CIRAFP.911'
      go to 999
910   write(*,901) '..'//PATH_SEPARATOR//'DATABASE'//PATH_SEPARATOR//'CIRAFP.MAX'
      pause 'Could not OPEN file ..'//PATH_SEPARATOR//'DATABASE'//PATH_SEPARATOR//'CIRAFP.MAX'
999   return
      end
c------------------------------------------------------------
