...
c          read the foF2 coefficients (CCIR or URSI88)
      ...
      OPEN(lu2,FILE=trim(root_directory)//PATH_SEPARATOR//'coeffs'//PATH_SEPARATOR//foF2_name,
...
c          read the rest of the coefficients
      ...
      OPEN(lu2,FILE=trim(root_directory)//PATH_SEPARATOR//'coeffs'//PATH_SEPARATOR//coeff_name,
...
270   FM3COF(I,J)=(XFM3CF(I,J,1)*ssn100+XFM3CF(I,J,2)*SSN)/100.
      RETURN
900   write(*,901) trim(root_directory)//PATH_SEPARATOR//'coeffs'//PATH_SEPARATOR//fof2_name
901   format(' Could not OPEN file=',a)
      stop 'OPEN error in redmap at 900'
910   write(*,901) trim(root_directory)//PATH_SEPARATOR//'coeffs'//PATH_SEPARATOR//coeff_name
